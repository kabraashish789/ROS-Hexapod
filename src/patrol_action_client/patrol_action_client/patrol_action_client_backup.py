...
class Turtlebot3PatrolClient(Node):
    ...
    def send_goal(self, goal:Float64MultiArray):
        ...
        goal_msg.revolut10 = goal.data[10]
        goal_msg.revolut11 = goal.data[11]
        goal_msg.revolut12 = goal.data[12]
        goal_msg.revolut13 = goal.data[13]
        goal_msg.revolut14 = goal.data[14]
        ...
        while not self._action_client.wait_for_server(1) :
         ...
         while rclpy.ok():
            ...
            for k in range(6):
                ...
                xyz_from_base_to_world = action_client.FromWorldToRobotBase(
                    legnumber, action_client.leg0_xHome, action_client.leg0_yHome, action_client.leg0_zHome)
                ...
                qAct_leg0 = np.array(
                    [action_client.leg0_q1_start, action_client.leg0_q2_start, action_client.leg0_q3_start])

                PStart_leg0 = np.array(
                    [action_client.leg0_xHome, action_client.leg0_yHome, action_client.leg0_zHome])
                PACt_leg0 = PStart_leg0

                i = 0
                for i in range(N):
                    start_time = action_client._clock.now().nanoseconds
                    ...
                    action_client.commands_Position_leg024.data[legnumber] = qAct_leg0[0]
