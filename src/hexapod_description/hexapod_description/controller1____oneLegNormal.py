...
class Controller(Node):
        ...
        try:
            while rclpy.ok():
               ...
               for k in range(1):
                ...
                xyz_from_world_to_base=self.forwardKinematics(self.array_of_q[legnumber],self.array_of_q[legnumber+6],self.array_of_q[legnumber+12])
                XGoal_leg0 = np.array(
                ...
                qAct_leg0 = np.array(
                    [self.array_of_q[legnumber], self.array_of_q[legnumber +6], self.array_of_q[legnumber +12]])
    ...
    def setStartXYZPosition(self):
       for i in range(6):
          ...
          self.array_of_position[i]=self.leg0_xHome
          self.array_of_position[i+6]=self.leg0_yHome 
          self.array_of_position[i+12]=self.leg0_zHome
