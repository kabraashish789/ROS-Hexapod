    ...
    def __init__(self):
        ...
        try:
         while rclpy.ok():
            ...
            XGoal_leg0=np.array([self.leg0_xHome, self.leg0_yHome, lift_z + self.leg0_zHome])
            ...
            XGoal_leg2=np.array([self.leg2_xHome, self.leg2_yHome, lift_z + self.leg2_zHome])
            ...
            XGoal_leg4=np.array([self.leg4_xHome, self.leg4_yHome, lift_z + self.leg4_zHome])
            ...
            XGoal_leg0=np.array([PACt_leg0[0], self.leg0_yHome, self.leg0_zHome])
            deltaX_leg0=np.array([0.0, 0.0, 0.0])
            path_leg0=np.array([0.0, 0.0, 0.0])

            XGoal_leg2=np.array([self.leg2_xHome,PACt_leg2[1], self.leg2_zHome])
            deltaX_leg2=np.array([0.0, 0.0, 0.0])
            path_leg2=np.array([0.0, 0.0, 0.0])
           

            XGoal_leg4=np.array([self.leg4_xHome,PACt_leg4[1], self.leg4_zHome])
            deltaX_leg4=np.array([0.0, 0.0, 0.0])
            path_leg4=np.array([0.0, 0.0, 0.0])
            ...
            # lifting in z-direction
            XGoal_leg1=np.array([self.leg1_xHome, self.leg1_yHome, self.leg1_zHome +lift_z])
            ...
            XGoal_leg3=np.array([self.leg3_xHome, self.leg3_yHome,self.leg3_zHome + lift_z])
            ...
            XGoal_leg5=np.array([self.leg5_xHome, self.leg5_yHome,self.leg5_zHome + lift_z])
            ...
            time.sleep(0.02)  
            # next -movement
            XGoal_leg1=np.array([ PACt_leg1[0],PACt_leg1[1] -For_Y, PACt_leg1[2]])
            deltaX_leg1=np.array([0.0, 0.0, 0.0])
            path_leg1=np.array([0.0, 0.0, 0.0])

            XGoal_leg3=np.array([PACt_leg3[0] - Forw_X,PACt_leg3[1],PACt_leg3[2]])
            deltaX_leg3=np.array([0.0, 0.0, 0.0])
            path_leg3=np.array([0.0, 0.0, 0.0])
           

            XGoal_leg5=np.array([PACt_leg5[0],PACt_leg5[1] + For_Y, PACt_leg5[2]])
            deltaX_leg5=np.array([0.0, 0.0, 0.0])
            path_leg5=np.array([0.0, 0.0, 0.0])
            ...
            XGoal_leg1=np.array([ self.leg1_xHome, PACt_leg1[1], self.leg1_zHome])
            deltaX_leg1=np.array([0.0, 0.0, 0.0])
            path_leg1=np.array([0.0, 0.0, 0.0])

            XGoal_leg3=np.array([PACt_leg3[0], self.leg3_yHome, self.leg3_zHome])
            deltaX_leg3=np.array([0.0, 0.0, 0.0])
            path_leg3=np.array([0.0, 0.0, 0.0])
           

            XGoal_leg5=np.array([self.leg5_xHome, PACt_leg5[1], self.leg5_zHome])
            deltaX_leg5=np.array([0.0, 0.0, 0.0])
            path_leg5=np.array([0.0, 0.0, 0.0])
