         ...
         while rclpy.ok():
            ...
            for k in range(2):
                ...
                xyz_in_world_first_leg_stance = action_client.FromWorldToRobotBase(
                    stance_leg, action_client.array_of_position[stance_leg], action_client.array_of_position[stance_leg +6], action_client.array_of_position[stance_leg+12])
                ...
                qAct_first_leg_stance=np.array([action_client.array_of_q[stance_leg],action_client.array_of_q[stance_leg+6],action_client.array_of_q[stance_leg+12]])
                PStart_first_leg_stance = np.array(
                    [action_client.array_of_position[stance_leg], action_client.array_of_position[stance_leg +6], action_client.array_of_position[stance_leg+12]])
                PACt_first_leg_stance = PStart_first_leg_stance

                xyz_in_world_second_leg_stance = action_client.FromWorldToRobotBase(
                    stance_leg+second_leg, action_client.array_of_position[stance_leg+second_leg], action_client.array_of_position[stance_leg+second_leg +6], action_client.array_of_position[stance_leg +second_leg+12])
                ...
                qAct_second_leg_stance=np.array([action_client.array_of_q[stance_leg +second_leg],action_client.array_of_q[stance_leg +second_leg+6],action_client.array_of_q[stance_leg +second_leg+12]])
                PStart_second_leg_stance = np.array(
                    [action_client.array_of_position[stance_leg+second_leg], action_client.array_of_position[stance_leg+second_leg +6], action_client.array_of_position[stance_leg+second_leg+12]])
                PACt_second_leg_stance = PStart_second_leg_stance

                xyz_in_world_third_leg_stance = action_client.FromWorldToRobotBase(
                    stance_leg +third_leg, action_client.array_of_position[stance_leg+third_leg], action_client.array_of_position[stance_leg +third_leg +6], action_client.array_of_position[stance_leg +third_leg+12])
                ...
                qAct_third_leg_stance=np.array([action_client.array_of_q[stance_leg+third_leg],action_client.array_of_q[stance_leg +third_leg+6],action_client.array_of_q[stance_leg +third_leg+12]])
                PStart_third_leg_stance = np.array(
                    [action_client.array_of_position[stance_leg+third_leg], action_client.array_of_position[stance_leg+third_leg +6], action_client.array_of_position[stance_leg+third_leg+12]])
                ...
                for i in range(N):
                    ...
                    action_client.commands_Position_leg024_stance.data[0] = qAct_first_leg_stance[0]+ action_client.temp_error[stance_leg]
                    action_client.commands_Position_leg024_stance.data[1
                                                       ] = qAct_first_leg_stance[1]+ + action_client.temp_error[stance_leg+6]
                    action_client.commands_Position_leg024_stance.data[2
                                                       ] = qAct_first_leg_stance[2]+ action_client.temp_error[stance_leg+12]
                   
                    action_client.commands_Position_leg024_stance.data[3] = qAct_second_leg_stance[0]+ action_client.temp_error[stance_leg+second_leg]
                    action_client.commands_Position_leg024_stance.data[4
                                                       ] = qAct_second_leg_stance[1]+ + action_client.temp_error[stance_leg+second_leg+6]
                    action_client.commands_Position_leg024_stance.data[5
                                                      ] = qAct_second_leg_stance[2]+ action_client.temp_error[stance_leg+second_leg+12]  
                    action_client.commands_Position_leg024_stance.data[6] = qAct_third_leg_stance[0]+ action_client.temp_error[stance_leg+third_leg]
                    action_client.commands_Position_leg024_stance.data[7
                                                       ] = qAct_third_leg_stance[1]+ + action_client.temp_error[stance_leg+third_leg+6]
                    action_client.commands_Position_leg024_stance.data[8
                                                       ] = qAct_third_leg_stance[2]+ action_client.temp_error[stance_leg+third_leg+12]
                ...
                xyz_in_robot_base_third_leg = action_client.FromRobotBaseToWorld(
                    legnumber+third_leg, xyz_in_world_third_leg[0], xyz_in_world_third_leg[1] - 2*For_stance, xyz_in_world_third_leg[2])
                XGoal_third_leg = xyz_in_robot_base_third_leg
                PStart_third_leg = PACt_third_leg
                
                xyz_in_world_first_leg_stance = action_client.FromWorldToRobotBase(
                    stance_leg, PACt_first_leg_stance[0], PACt_first_leg_stance[1], PACt_first_leg_stance[2])
                xyz_in_robot_base_first_leg_stance = action_client.FromRobotBaseToWorld(
                    stance_leg, xyz_in_world_first_leg_stance[0], xyz_in_world_first_leg_stance[1] - 2*For_stance, xyz_in_world_first_leg_stance[2])
                XGoal_first_leg_stance = xyz_in_robot_base_first_leg_stance
                PStart_first_leg_stance = PACt_first_leg_stance
                
                xyz_in_world_second_leg_stance = action_client.FromWorldToRobotBase(
                    stance_leg+second_leg, PACt_second_leg_stance[0], PACt_second_leg_stance[1], PACt_second_leg_stance[2])
                xyz_in_robot_base_second_leg_stance = action_client.FromRobotBaseToWorld(
                    stance_leg+second_leg, xyz_in_world_second_leg_stance[0], xyz_in_world_second_leg_stance[1] - For_Y, xyz_in_world_second_leg_stance[2])
                XGoal_second_leg_stance = xyz_in_robot_base_second_leg_stance
                PStart_second_leg_stance = PACt_second_leg_stance

                xyz_in_world_third_leg_stance = action_client.FromWorldToRobotBase(
                    stance_leg+third_leg, PACt_third_leg_stance[0], PACt_third_leg_stance[1], PACt_third_leg_stance[2])
                xyz_in_robot_base_third_leg = action_client.FromRobotBaseToWorld(
                    stance_leg+third_leg, xyz_in_world_third_leg_stance[0], xyz_in_world_third_leg_stance[1] - 2*For_stance, xyz_in_world_third_leg_stance[2])
                XGoal_third_leg_stance = xyz_in_robot_base_third_leg_stance
                PStart_third_leg_stance = PACt_third_leg_stance
                ...
                xyz_in_world_third_leg = action_client.FromWorldToRobotBase(
                    legnumber + third_leg, PACt_third_leg[0], PACt_third_leg[1], PACt_third_leg[2])
                xyz_in_robot_base_third_leg = action_client.FromRobotBaseToWorld(
                    legnumber+third_leg, xyz_in_world_third_leg[0], xyz_in_world_third_leg[1] - 3*For_stance, xyz_in_world_third_leg[2])
                XGoal_third_leg = xyz_in_robot_base_third_leg
                PStart_third_leg = PACt_third_leg
                ...
                xyz_in_world_first_leg_stance = action_client.FromWorldToRobotBase(
                    stance_leg, PACt_first_leg_stance[0], PACt_first_leg_stance[1], PACt_first_leg_stance[2])
                xyz_in_robot_base_first_leg_stance = action_client.FromRobotBaseToWorld(
                    stance_leg, xyz_in_world_first_leg_stance[0], xyz_in_world_first_leg_stance[1] - 3*For_stance, xyz_in_world_first_leg_stance[2])
                XGoal_first_leg_stance = xyz_in_robot_base_first_leg_stance
                PStart_first_leg_stance = PACt_first_leg_stance
                ...
                xyz_in_world_third_leg_stance = action_client.FromWorldToRobotBase(
                    stance_leg+third_leg, PACt_third_leg_stance[0], PACt_third_leg_stance[1], PACt_third_leg_stance[2])
                xyz_in_robot_base_third_leg = action_client.FromRobotBaseToWorld(
                    stance_leg+third_leg, xyz_in_world_third_leg_stance[0], xyz_in_world_third_leg_stance[1] - 3*For_stance, xyz_in_world_third_leg_stance[2])
                XGoal_third_leg_stance = xyz_in_robot_base_third_leg_stance
                PStart_third_leg_stance = PACt_third_leg_stance
