...
class HexapodClient(Node):
    ...
    def __init__(self):
        ...
        length = 87.3/1000           #87.3/1000       #0.1127         #87.3/1000    #112/1000, 87/1000
        width = length
    ...
    def send_goal(self, goal:Float64MultiArray):
        ...
        goal_msg.leg_number=goal.data[3]
...
def main(args=None):
    ...
    global qAct_leg0, legnumber, qAct_leg2 , qAct_leg4, oneStepMotionIsFinished
    legnumber=0
    ...
    try:
         while rclpy.ok():
            ...
            for k in range(1):
                '''if k==3 or k==2 or k==4 or k==1 or k==5:
                 continue'''
                ...
                for i in range(N):
                    ...
                    action_client.commands_Position_leg024.data[0] = qAct_leg0[0]+ action_client.temp_error[legnumber]
                    action_client.commands_Position_leg024.data[1 
                                                       ] = qAct_leg0[1]+ + action_client.temp_error[legnumber+6]
                    action_client.commands_Position_leg024.data[2 
                                                       ] = qAct_leg0[2]+ action_client.temp_error[legnumber+12]
                    action_client.commands_Position_leg024.data[3]=legnumber
                ...
                XGoal_leg0 = np.array(
                    [xyz_from_world_to_base[0], xyz_from_world_to_base[1],0.0])
