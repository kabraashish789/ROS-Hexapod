...
class HexapodClient(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info("my controller  action client has been initialised1.")
...
def main(args=None):
    ...
    global qAct_first_leg, legnumber, GoToSwing, GoToStance, oneStepMotionIsFinished
    GoToSwing=True
    GoToStance=False
    For_Y=30
    For_stance=100
    ...
    try:
         while rclpy.ok():
            N =10 # Number of iterations to achieve the desired goal, play with to change the speed
            ...
            for k in range(2):
                ...
                xyz_in_world_first_leg_stance = action_client.FromWorldToRobotBase(
                    stance_leg, action_client.array_of_position_stance[stance_leg], action_client.array_of_position_stance[stance_leg +6], action_client.array_of_position_stance[stance_leg+12])
                xyz_in_robot_base_first_leg_stance = action_client.FromRobotBaseToWorld(
                    stance_leg, xyz_in_world_first_leg_stance[0], xyz_in_world_first_leg_stance[1]-For_stance, xyz_in_world_first_leg_stance[2] )
    
                XGoal_first_leg_stance =xyz_in_robot_base_first_leg_stance
                deltaX_first_leg_stance = np.array([0.0, 0.0, 0.0])
                PACt_first_leg_stance = np.array([0.0, 0.0, 0.0])
                path_first_leg_stance = np.array([0.0, 0.0, 0.0])
                qAct_first_leg_stance=np.array([action_client.array_of_q_stance[stance_leg],action_client.array_of_q_stance[stance_leg+6],action_client.array_of_q_stance[stance_leg+12]])
                PStart_first_leg_stance = np.array(
                    [action_client.array_of_position_stance[stance_leg], action_client.array_of_position_stance[stance_leg +6], action_client.array_of_position_stance[stance_leg+12]])
                PACt_first_leg_stance = PStart_first_leg_stance

                xyz_in_world_second_leg_stance = action_client.FromWorldToRobotBase(
                    stance_leg+second_leg, action_client.array_of_position_stance[stance_leg+second_leg], action_client.array_of_position_stance[stance_leg+second_leg +6], action_client.array_of_position_stance[stance_leg +second_leg+12])
                xyz_in_robot_base_second_leg_stance = action_client.FromRobotBaseToWorld(
                    stance_leg +second_leg, xyz_in_world_second_leg_stance[0], xyz_in_world_second_leg_stance[1]-For_stance, xyz_in_world_second_leg_stance[2] )
                XGoal_second_leg_stance =xyz_in_robot_base_second_leg_stance
                deltaX_second_leg_stance = np.array([0.0, 0.0, 0.0])
                PACt_second_leg_stance = np.array([0.0, 0.0, 0.0])
                path_second_leg_stance = np.array([0.0, 0.0, 0.0])
                qAct_second_leg_stance=np.array([action_client.array_of_q_stance[stance_leg +second_leg],action_client.array_of_q_stance[stance_leg +second_leg+6],action_client.array_of_q_stance[stance_leg +second_leg+12]])
                PStart_second_leg_stance = np.array(
                    [action_client.array_of_position_stance[stance_leg+second_leg], action_client.array_of_position_stance[stance_leg+second_leg +6], action_client.array_of_position_stance[stance_leg+second_leg+12]])
                PACt_second_leg_stance = PStart_second_leg_stance

                xyz_in_world_third_leg_stance = action_client.FromWorldToRobotBase(
                    stance_leg +third_leg, action_client.array_of_position_stance[stance_leg+third_leg], action_client.array_of_position_stance[stance_leg +third_leg +6], action_client.array_of_position_stance[stance_leg +third_leg+12])
                xyz_in_robot_base_third_leg_stance = action_client.FromRobotBaseToWorld(
                    stance_leg + third_leg, xyz_in_world_third_leg_stance[0], xyz_in_world_third_leg_stance[1]-For_stance, xyz_in_world_third_leg_stance[2] )
                
                XGoal_third_leg_stance =xyz_in_robot_base_third_leg_stance
                deltaX_third_leg_stance = np.array([0.0, 0.0, 0.0])
                PACt_third_leg_stance = np.array([0.0, 0.0, 0.0])
                path_third_leg_stance = np.array([0.0, 0.0, 0.0])
                qAct_third_leg_stance=np.array([action_client.array_of_q_stance[stance_leg+third_leg],action_client.array_of_q_stance[stance_leg +third_leg+6],action_client.array_of_q_stance[stance_leg +third_leg+12]])
                PStart_third_leg_stance = np.array(
                    [action_client.array_of_position_stance[stance_leg+third_leg], action_client.array_of_position_stance[stance_leg+third_leg +6], action_client.array_of_position_stance[stance_leg+third_leg+12]])
                PACt_third_leg_stance = PStart_third_leg_stance
                ...
                for i in range(N):
                    ...
                    path_first_leg_stance = PStart_first_leg_stance + \
                        (XGoal_first_leg_stance - PStart_first_leg_stance)*(i)/(N-1)
                    deltaX_first_leg_stance = path_first_leg_stance - PACt_first_leg_stance
                    dq_first_leg_stance = action_client.inverseKinematics(
                        qAct_first_leg_stance[0], qAct_first_leg_stance[1], qAct_first_leg_stance[2], deltaX_first_leg_stance[0], deltaX_first_leg_stance[1], deltaX_first_leg_stance[2])
                    qAct_first_leg_stance = qAct_first_leg_stance + dq_first_leg_stance
                 
                    path_second_leg_stance = PStart_second_leg_stance + \
                        (XGoal_second_leg_stance - PStart_second_leg_stance)*(i)/(N-1)
                    deltaX_second_leg_stance = path_second_leg_stance - PACt_second_leg_stance
                    dq_second_leg_stance = action_client.inverseKinematics(
                        qAct_second_leg_stance[0], qAct_second_leg_stance[1], qAct_second_leg_stance[2], deltaX_second_leg_stance[0], deltaX_second_leg_stance[1], deltaX_second_leg_stance[2])
                    qAct_second_leg_stance= qAct_second_leg_stance + dq_second_leg_stance
                    
                    
                    path_third_leg_stance = PStart_third_leg_stance + \
                        (XGoal_third_leg_stance - PStart_third_leg_stance)*(i)/(N-1)
                    deltaX_third_leg_stance = path_third_leg_stance - PACt_third_leg_stance
                    dq_third_leg_stance = action_client.inverseKinematics(
                        qAct_third_leg_stance[0], qAct_third_leg_stance[1], qAct_third_leg_stance[2], deltaX_third_leg_stance[0], deltaX_third_leg_stance[1], deltaX_third_leg_stance[2])
                    qAct_third_leg_stance = qAct_third_leg_stance + dq_third_leg_stance
                    
                    
                    
                    action_client.commands_Position_leg024_stance.data[0] = qAct_first_leg_stance[0]
                    action_client.commands_Position_leg024_stance.data[1
                                                       ] = qAct_first_leg_stance[1]
                    action_client.commands_Position_leg024_stance.data[2
                                                       ] = qAct_first_leg_stance[2]
                   
                    action_client.commands_Position_leg024_stance.data[3] = qAct_second_leg_stance[0]
                    action_client.commands_Position_leg024_stance.data[4
                                                       ] = qAct_second_leg_stance[1]
                    action_client.commands_Position_leg024_stance.data[5
                                                      ] = qAct_second_leg_stance[2] 
                    action_client.commands_Position_leg024_stance.data[6] = qAct_third_leg_stance[0]
                    action_client.commands_Position_leg024_stance.data[7
                                                       ] = qAct_third_leg_stance[1]
                    action_client.commands_Position_leg024_stance.data[8
                                                       ] = qAct_third_leg_stance[2]
         
                    #action_client.get_logger().info(f" q:  \n {(  action_client.commands_Position_leg024)} ")
                    action_client.commands_Position_leg024_stance.data[9]=stance_leg
                    action_client.send_goal(action_client.commands_Position_leg024_stance) 
                    rclpy.spin_once(action_client,executor=executor,timeout_sec=0.001)  
                    PACt_first_leg_stance = action_client.forwardKinematics(
                        qAct_first_leg_stance[0], qAct_first_leg_stance[1], qAct_first_leg_stance[2])
                    PACt_second_leg_stance = action_client.forwardKinematics(
                        qAct_second_leg_stance[0], qAct_second_leg_stance[1], qAct_second_leg_stance[2])
                    PACt_third_leg_stance = action_client.forwardKinematics(
                        qAct_third_leg_stance[0], qAct_third_leg_stance[1], qAct_third_leg_stance[2])
                ...
                xyz_in_world_third_leg = action_client.FromWorldToRobotBase(
                    legnumber+ third_leg, PACt_third_leg[0], PACt_third_leg[1], PACt_third_leg[2])
                xyz_in_robot_base_third_leg = action_client.FromRobotBaseToWorld(
                    legnumber +third_leg, xyz_in_world_third_leg[0], xyz_in_world_third_leg[1] ,xyz_in_world_third_leg[2]-lift_z)
                XGoal_third_leg = xyz_in_robot_base_third_leg
                ...
                action_client.array_of_position[stance_leg]=PACt_first_leg_stance[0]    
                action_client.array_of_position[stance_leg+6]=PACt_first_leg_stance[1]  
                action_client.array_of_position[stance_leg+12]=PACt_first_leg_stance[2]  
                action_client.array_of_position[stance_leg+second_leg]=PACt_second_leg_stance[0]  
                action_client.array_of_position[stance_leg+second_leg+6]=PACt_second_leg_stance[1]  
                action_client.array_of_position[stance_leg+second_leg+12]=PACt_second_leg_stance[2]  
                action_client.array_of_position[stance_leg+third_leg]=PACt_third_leg_stance[0]  
                action_client.array_of_position[stance_leg+third_leg+6]=PACt_third_leg_stance[1]  
                action_client.array_of_position[stance_leg+third_leg+12]=PACt_third_leg_stance[2]  

                action_client.array_of_q[stance_leg]=qAct_first_leg_stance[0]    
                action_client.array_of_q[stance_leg+6]=qAct_first_leg_stance[1]  
                action_client.array_of_q[stance_leg+12]=qAct_first_leg_stance[2]  
                action_client.array_of_q[stance_leg+second_leg]=qAct_second_leg_stance[0]  
                action_client.array_of_q[stance_leg+second_leg+6]=qAct_second_leg_stance[1]  
                action_client.array_of_q[stance_leg+second_leg+12]=qAct_second_leg_stance[2]  
                action_client.array_of_q[stance_leg+third_leg]=qAct_third_leg_stance[0]  
                action_client.array_of_q[stance_leg+third_leg+6]=qAct_third_leg_stance[1]  
                action_client.array_of_q[stance_leg+third_leg+12]=qAct_third_leg_stance[2]
                
                action_client.array_of_position_stance[legnumber]=PACt_first_leg[0]    
                action_client.array_of_position_stance[legnumber+6]=PACt_first_leg[1]  
                action_client.array_of_position_stance[legnumber+12]=PACt_first_leg[2]  
                action_client.array_of_position_stance[legnumber+second_leg]=PACt_second_leg[0]  
                action_client.array_of_position_stance[legnumber+second_leg+6]=PACt_second_leg[1]  
                action_client.array_of_position_stance[legnumber+second_leg+12]=PACt_second_leg[2]  
                action_client.array_of_position_stance[legnumber+third_leg]=PACt_third_leg[0]  
                action_client.array_of_position_stance[legnumber+third_leg+6]=PACt_third_leg[1]  
                action_client.array_of_position_stance[legnumber+third_leg+12]=PACt_third_leg[2]  

                action_client.array_of_q_stance[legnumber]=qAct_first_leg[0]    
                action_client.array_of_q_stance[legnumber+6]=qAct_first_leg[1]  
                action_client.array_of_q_stance[legnumber+12]=qAct_first_leg[2]  
                action_client.array_of_q_stance[legnumber+second_leg]=qAct_second_leg[0]  
                action_client.array_of_q_stance[legnumber+second_leg+6]=qAct_second_leg[1]  
                action_client.array_of_q_stance[legnumber+second_leg+12]=qAct_second_leg[2]  
                action_client.array_of_q_stance[legnumber+third_leg]=qAct_third_leg[0]  
                action_client.array_of_q_stance[legnumber+third_leg+6]=qAct_third_leg[1]  
                action_client.array_of_q_stance[legnumber+third_leg+12]=qAct_third_leg[2]
