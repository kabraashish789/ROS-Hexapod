...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            executable="spawner.py",
            output='screen',    
            arguments=["my_position_controller7" ],
            ),  
         ...
         Node(
            ...
            executable="spawner.py",
            output='screen',    
            arguments=["my_position_controller8" ],
            ),  
         Node(
            package="controller_manager",
            executable="spawner.py",
            output='screen',    
            arguments=["my_position_controller9" ],
            ),  
         Node(
            package="controller_manager",
            executable="spawner.py",
            output='screen',    
            arguments=["my_position_controller10" ],
            ),            
         ...
         Node(
            ...
            executable="spawner.py",
            output='screen',    
            arguments=["my_position_controller11" ],
            ), 
        Node(
            package="controller_manager",
            executable="spawner.py",
            output='screen',    
            arguments=["my_position_controller12" ],
            ),
        ...
        Node(
            ...
            executable="spawner.py",
            output='screen',    
            arguments=["my_position_controller13" ],
            ),  
         ...
         Node(
            ...
            executable="spawner.py",
            output='screen',    
            arguments=["my_position_controller14" ],
            ),  
         Node(
            package="controller_manager",
            executable="spawner.py",
            output='screen',    
            arguments=["my_position_controller15" ],
            ),  
         Node(
            package="controller_manager",
            executable="spawner.py",
            output='screen',    
            arguments=["my_position_controller16" ],
            ),            
         ...
         Node(
            ...
            executable="spawner.py",
            output='screen',    
            arguments=["my_position_controller17" ],
            ), 
        Node(
            package="controller_manager",
            executable="spawner.py",
            output='screen',    
            arguments=["my_position_controller18" ],
            ),         
        ]) 
