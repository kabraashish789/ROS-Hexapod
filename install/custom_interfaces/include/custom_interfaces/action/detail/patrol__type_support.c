...
#include <stddef.h>
#include "custom_interfaces/action/detail/patrol__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  custom_interfaces__action__Patrol_Goal__init(message_memory);
}

void Patrol_Goal__rosidl_typesupport_introspection_c__Patrol_Goal_fini_function(void * message_memory)
{
  custom_interfaces__action__Patrol_Goal__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Patrol_Goal__rosidl_typesupport_introspection_c__Patrol_Goal_message_member_array[10] = {
  {
    "revolut1",  // name
    ...
    offsetof(custom_interfaces__action__Patrol_Goal, revolut1),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces__action__Patrol_Goal, revolut2),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces__action__Patrol_Goal, revolut3),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces__action__Patrol_Goal, revolut4),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces__action__Patrol_Goal, revolut5),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces__action__Patrol_Goal, revolut6),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces__action__Patrol_Goal, revolut7),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces__action__Patrol_Goal, revolut8),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces__action__Patrol_Goal, revolut9),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces__action__Patrol_Goal, leg_number),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Patrol_Goal__rosidl_typesupport_introspection_c__Patrol_Goal_message_members = {
  ...
  10,  // number of fields
  sizeof(custom_interfaces__action__Patrol_Goal),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interfaces, action, Patrol_Goal)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  custom_interfaces__action__Patrol_Result__init(message_memory);
}

void Patrol_Result__rosidl_typesupport_introspection_c__Patrol_Result_fini_function(void * message_memory)
{
  custom_interfaces__action__Patrol_Result__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Patrol_Result__rosidl_typesupport_introspection_c__Patrol_Result_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces__action__Patrol_Result, success),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Patrol_Result__rosidl_typesupport_introspection_c__Patrol_Result_message_members = {
  ...
  1,  // number of fields
  sizeof(custom_interfaces__action__Patrol_Result),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_custom_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interfaces, action, Patrol_Result)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  custom_interfaces__action__Patrol_Feedback__init(message_memory);
}

void Patrol_Feedback__rosidl_typesupport_introspection_c__Patrol_Feedback_fini_function(void * message_memory)
{
  custom_interfaces__action__Patrol_Feedback__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Patrol_Feedback__rosidl_typesupport_introspection_c__Patrol_Feedback_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces__action__Patrol_Feedback, time_left),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Patrol_Feedback__rosidl_typesupport_introspection_c__Patrol_Feedback_message_members = {
  ...
  1,  // number of fields
  sizeof(custom_interfaces__action__Patrol_Feedback),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_custom_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interfaces, action, Patrol_Feedback)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  custom_interfaces__action__Patrol_SendGoal_Request__init(message_memory);
}
...
{
  custom_interfaces__action__Patrol_SendGoal_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Patrol_SendGoal_Request__rosidl_typesupport_introspection_c__Patrol_SendGoal_Request_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces__action__Patrol_SendGoal_Request, goal_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces__action__Patrol_SendGoal_Request, goal),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Patrol_SendGoal_Request__rosidl_typesupport_introspection_c__Patrol_SendGoal_Request_message_members = {
  ...
  2,  // number of fields
  sizeof(custom_interfaces__action__Patrol_SendGoal_Request),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_custom_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interfaces, action, Patrol_SendGoal_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  custom_interfaces__action__Patrol_SendGoal_Response__init(message_memory);
}
...
{
  custom_interfaces__action__Patrol_SendGoal_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Patrol_SendGoal_Response__rosidl_typesupport_introspection_c__Patrol_SendGoal_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces__action__Patrol_SendGoal_Response, accepted),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces__action__Patrol_SendGoal_Response, stamp),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Patrol_SendGoal_Response__rosidl_typesupport_introspection_c__Patrol_SendGoal_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(custom_interfaces__action__Patrol_SendGoal_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_custom_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interfaces, action, Patrol_SendGoal_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers custom_interfaces__action__detail__patrol__rosidl_typesupport_introspection_c__Patrol_SendGoal_service_members = {
  "custom_interfaces__action",  // service namespace
  "Patrol_SendGoal",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // custom_interfaces__action__detail__patrol__rosidl_typesupport_introspection_c__Patrol_SendGoal_Request_message_type_support_handle,
  NULL  // response message
  // custom_interfaces__action__detail__patrol__rosidl_typesupport_introspection_c__Patrol_SendGoal_Response_message_type_support_handle
};

static rosidl_service_type_support_t custom_interfaces__action__detail__patrol__rosidl_typesupport_introspection_c__Patrol_SendGoal_service_type_support_handle = {
  0,
  &custom_interfaces__action__detail__patrol__rosidl_typesupport_introspection_c__Patrol_SendGoal_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interfaces, action, Patrol_SendGoal)() {
  if (!custom_interfaces__action__detail__patrol__rosidl_typesupport_introspection_c__Patrol_SendGoal_service_type_support_handle.typesupport_identifier) {
    custom_interfaces__action__detail__patrol__rosidl_typesupport_introspection_c__Patrol_SendGoal_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)custom_interfaces__action__detail__patrol__rosidl_typesupport_introspection_c__Patrol_SendGoal_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interfaces, action, Patrol_SendGoal_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interfaces, action, Patrol_SendGoal_Response)()->data;
  }

  return &custom_interfaces__action__detail__patrol__rosidl_typesupport_introspection_c__Patrol_SendGoal_service_type_support_handle;
}
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  custom_interfaces__action__Patrol_GetResult_Request__init(message_memory);
}
...
{
  custom_interfaces__action__Patrol_GetResult_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Patrol_GetResult_Request__rosidl_typesupport_introspection_c__Patrol_GetResult_Request_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces__action__Patrol_GetResult_Request, goal_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Patrol_GetResult_Request__rosidl_typesupport_introspection_c__Patrol_GetResult_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(custom_interfaces__action__Patrol_GetResult_Request),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_custom_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interfaces, action, Patrol_GetResult_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  custom_interfaces__action__Patrol_GetResult_Response__init(message_memory);
}
...
{
  custom_interfaces__action__Patrol_GetResult_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Patrol_GetResult_Response__rosidl_typesupport_introspection_c__Patrol_GetResult_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces__action__Patrol_GetResult_Response, status),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces__action__Patrol_GetResult_Response, result),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Patrol_GetResult_Response__rosidl_typesupport_introspection_c__Patrol_GetResult_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(custom_interfaces__action__Patrol_GetResult_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_custom_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interfaces, action, Patrol_GetResult_Response)() {
...
// this is intentionally not const to allow initialization later to prevent an initialization race
static rosidl_typesupport_introspection_c__ServiceMembers custom_interfaces__action__detail__patrol__rosidl_typesupport_introspection_c__Patrol_GetResult_service_members = {
  "custom_interfaces__action",  // service namespace
  "Patrol_GetResult",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // custom_interfaces__action__detail__patrol__rosidl_typesupport_introspection_c__Patrol_GetResult_Request_message_type_support_handle,
  NULL  // response message
  // custom_interfaces__action__detail__patrol__rosidl_typesupport_introspection_c__Patrol_GetResult_Response_message_type_support_handle
};

static rosidl_service_type_support_t custom_interfaces__action__detail__patrol__rosidl_typesupport_introspection_c__Patrol_GetResult_service_type_support_handle = {
  0,
  &custom_interfaces__action__detail__patrol__rosidl_typesupport_introspection_c__Patrol_GetResult_service_members,
  get_service_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_custom_interfaces
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interfaces, action, Patrol_GetResult)() {
  if (!custom_interfaces__action__detail__patrol__rosidl_typesupport_introspection_c__Patrol_GetResult_service_type_support_handle.typesupport_identifier) {
    custom_interfaces__action__detail__patrol__rosidl_typesupport_introspection_c__Patrol_GetResult_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)custom_interfaces__action__detail__patrol__rosidl_typesupport_introspection_c__Patrol_GetResult_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interfaces, action, Patrol_GetResult_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interfaces, action, Patrol_GetResult_Response)()->data;
  }

  return &custom_interfaces__action__detail__patrol__rosidl_typesupport_introspection_c__Patrol_GetResult_service_type_support_handle;
}
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  custom_interfaces__action__Patrol_FeedbackMessage__init(message_memory);
}
...
{
  custom_interfaces__action__Patrol_FeedbackMessage__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Patrol_FeedbackMessage__rosidl_typesupport_introspection_c__Patrol_FeedbackMessage_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces__action__Patrol_FeedbackMessage, goal_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces__action__Patrol_FeedbackMessage, feedback),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Patrol_FeedbackMessage__rosidl_typesupport_introspection_c__Patrol_FeedbackMessage_message_members = {
  ...
  2,  // number of fields
  sizeof(custom_interfaces__action__Patrol_FeedbackMessage),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_custom_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interfaces, action, Patrol_FeedbackMessage)() {
