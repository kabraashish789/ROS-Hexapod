    ...
    try:
         while rclpy.ok():
            ...
            for k in range(2):
                ...
                #xyz_from_world_to_base=np.array([action_client.leg0_xHome, action_client.leg0_yHome, action_client.leg0_zHome])
