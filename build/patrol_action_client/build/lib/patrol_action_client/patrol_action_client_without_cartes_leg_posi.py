         ...
         while rclpy.ok():
            ...
            for k in range(2):
                ...
                xyz_in_robot_base_second_leg = action_client.FromRobotBaseToWorld(
                    legnumber +second_leg, xW, yW, lift_z)
                ...
                xyz_in_robot_base_third_leg = action_client.FromRobotBaseToWorld(
                    legnumber + third_leg, xW, yW, lift_z)
                ...
                xyz_in_robot_base_second_leg_stance = action_client.FromRobotBaseToWorld(
                    stance_leg +second_leg, xW, -For_stance, 0.0 )
                ...
                xyz_in_robot_base_third_leg_stance = action_client.FromRobotBaseToWorld(
                    stance_leg + third_leg, xW, -For_stance, 0.0 )
